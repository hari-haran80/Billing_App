...
export default function WeightManagementScreen() {
  ...
  const handleSave = async () => {
    ...
    if (isNaN(reductionValue) || reductionValue < 0 || reductionValue >= 1) {
      Alert.alert('Error', 'Please enter a valid reduction value between 0 and 1 (e.g., 0.1 for 100g per kg)');
      return;
    }
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>Configure L mode weight reduction</Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.inputContainer}>
          ...
          <Text style={styles.description}>
            Enter the reduction factor for L mode.
            Example: 0.1 means 100g reduction per 1kg (10%)
          </Text>
      ...
      <View style={styles.infoCard}>
        ...
        <Text style={styles.infoText}>
          ...
          • For example, if reduction is 0.1 (10%):{'\n'}
          • Machine shows 900g for actual 1kg weight{'\n'}
          • Database stores BOTH actual and L weight values{'\n'}
          • Customer receipt shows only the L weight{'\n'}
          • Admin can see both values in reports
        </Text>
      </View>
    </SafeAreaView>
  );
