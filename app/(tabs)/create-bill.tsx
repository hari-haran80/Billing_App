...
export default function CreateBillScreen() {
  ...
  const handleSaveBill = async (printAfterSave: boolean = false) => {
    ...
    for (const item of billItems) {
      ...
      if (item.unitType === 'count' && (!item.quantity || parseInt(item.quantity) <= 0)) {
    ...
    try {
      ...
      const billNumber = `BIL${Date.now().toString().slice(-8)}`;
  ...
  const handlePrintBill = async (billId: number, billNumber: string) => {
    ...
    try {
        ...
        items: billItems.map(item => {
          ...
          if (item.unitType === 'count') {
            ...
            return {
              ...
              lWeight: item.weightMode === 'L' ? parseFloat(item.weight) || 0 : 0,
              reducedWeight: 0,
      ...
      Alert.alert('Error', 'Failed to print bill. Make sure printer is connected.');
    } finally {
      setPrinting(false);
      setSaving(false);
    }
      ...
      >
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <Text style={[styles.headerSubtitle, { color: colors.textSecondary }]}>Create and save bills</Text>
          </View>
          ...
          <View style={[styles.card, { backgroundColor: colors.cardBackground }]}>
            <View style={styles.cardHeader}>
              ...
              <Text style={[styles.cardTitle, { color: colors.text }]}>Weight Mode</Text>
            </View>
            ...
            <View style={styles.weightModeContainer}>
              <TouchableOpacity
                style={[
                  ...
                  selectedWeightMode === 'normal' && { backgroundColor: colors.primary }
                ]}
                onPress={() => toggleWeightMode()}
              >
                <Text style={[
                  styles.weightModeText,
                  selectedWeightMode === 'normal' && styles.weightModeTextActive
                ]}>
                  Normal Mode
                </Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                style={[
                  styles.weightModeButton,
                  selectedWeightMode === 'L' && { backgroundColor: colors.warning }
                ]}
                onPress={() => toggleWeightMode()}
              >
                <Text style={[
            ...
            <Text style={[styles.weightModeInfo, { color: colors.textSecondary }]}>
          ...
          <View style={[styles.card, { backgroundColor: colors.cardBackground }]}>
            <View style={styles.cardHeaderRow}>
              <View style={styles.cardHeader}>
                ...
                <Text style={[styles.cardTitle, { color: colors.text }]}>Bill Items</Text>
              </View>
            </View>
            ...
            {billItems.map((item, index) => (
              <View key={item.id}>
                <BillItemRow
                  ...
                  onRemove={() => setBillItems(billItems.filter((i) => i.id !== item.id))}
                />
          ...
          <View style={[styles.totalCard, { backgroundColor: colors.primary }]}>
            <View style={styles.totalHeader}>
              ...
              <View style={styles.itemCount}>
                <Text style={styles.itemCountText}>{billItems.length} item(s)</Text>
              </View>
            </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: colors.cardBackground }]}>
            ...
            <View style={styles.modalBody}>
              ...
              <View style={styles.modalInputContainer}>
                <Text style={[styles.modalLabel, { color: colors.text }]}>Item Type</Text>
                <View style={styles.itemTypeContainer}>
                  <TouchableOpacity
                    style={[
                      styles.itemTypeButton,
                      newItemUnitType === 'weight' && { backgroundColor: colors.primary }
                    ]}
                    onPress={() => setNewItemUnitType('weight')}
                  >
                    <Text style={[
                      styles.itemTypeText,
                      newItemUnitType === 'weight' && styles.itemTypeTextActive
                    ]}>
                      Weight Item
                    </Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    style={[
                      styles.itemTypeButton,
                      newItemUnitType === 'count' && { backgroundColor: colors.primary }
                    ]}
                    onPress={() => setNewItemUnitType('count')}
                  >
                    <Text style={[
                      styles.itemTypeText,
                      newItemUnitType === 'count' && styles.itemTypeTextActive
                    ]}>
                      Bottle
                    </Text>
                  </TouchableOpacity>
              ...
              <View style={styles.modalInputContainer}>
                <Text style={[styles.modalLabel, { color: colors.text }]}>
                  {newItemUnitType === 'count' ? 'Price per unit (₹)' : 'Price per kg (₹)'}
                </Text>
                <TextInput
                  style={[styles.modalInput, { 
                    backgroundColor: colors.background, 
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: colors.cardBackground }]}>
            ...
            <View style={styles.modalBody}>
              <View style={styles.modalInputContainer}>
                <Text style={[styles.modalLabel, { color: colors.text }]}>Bottle Code *</Text>
                <TextInput
                  style={[styles.modalInput, { 
                    backgroundColor: colors.background, 
                    borderColor: colors.border,
              ...
              <View style={styles.modalInputContainer}>
                <Text style={[styles.modalLabel, { color: colors.text }]}>Display Name *</Text>
                <TextInput
                  style={[styles.modalInput, { 
                    backgroundColor: colors.background, 
                    borderColor: colors.border,
              ...
              <View style={styles.modalInputContainer}>
                <Text style={[styles.modalLabel, { color: colors.text }]}>Price per unit (₹) *</Text>
                <TextInput
                  style={[styles.modalInput, { 
                    backgroundColor: colors.background, 
                    borderColor: colors.border,
